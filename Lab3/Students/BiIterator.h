...
class BiIterator
{
    public:
        ...
        * \return true, if this iterator and it point to the same node. Otherwie, return false.
        *
        */
        ...
        *
        * \param it reference to the rhs iterator of the comparison.
        * \return true, if this iterator and it point to different nodes. Otherwie, return false.
        *
        */
